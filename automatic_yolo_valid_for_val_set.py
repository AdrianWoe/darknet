...
for iter_name in iter_names:
    ...
    # Uses the txt which is set at val= in iterX.data.
    target_root_dir = os.path.join('results', '{}_val'.format(iter_name))
    ...
    for weight_name in weight_names:
        ...
        for line in fileinput.input(os.path.join(iter_name, '{}.data'.format(iter_name)), inplace=True):
        ...
        command = 'CUDA_VISIBLE_DEVICES={} ./darknet detector valid {}/{}.data {}/{}_test.cfg {}/{} -dont_show'.format(
